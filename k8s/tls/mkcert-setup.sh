...
info "Secret applied."
info ""
info "Next steps (from repo root):"
info "  make gateway-apply   # applies GatewayClass + cluster-ingress (uses ${DOMAIN})"
info "  make o11y-install    # after gateway-apply succeeds"
info "  curl -I https://grafana.${DOMAIN}   # final verify"
info ""
